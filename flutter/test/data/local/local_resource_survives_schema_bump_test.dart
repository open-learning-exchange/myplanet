...
void main() {
  ...
  Future<String> saveLocalResource() async {
    final error = await resources.saveLocalResource(
      const LocalResourceRequest(
        ...
        userId: ada,
        addedBy: 'ada',
        resourceUrl: '/storage/emulated/0/ole/well-survey.pdf',
        mediaType: 'pdf',
      ),
    );
  ...
  test('a resource the user created offline survives a schema bump', () async {
    ...
    expect(
      ...
      '/storage/emulated/0/ole/well-survey.pdf',
      reason: 'the pointer to the file the user picked goes with it',
    );
    expect(
  ...
  test('a private team resource created offline also survives', () async {
    ...
    final error = await resources.saveLocalResource(
      const LocalResourceRequest(
        ...
        userId: ada,
        resourceUrl: '/storage/emulated/0/ole/budget.pdf',

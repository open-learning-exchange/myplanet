...
final feedbackByIdProvider = FutureProvider.family<FeedbackRow?, String>((ref, id) async {
  final repo = ref.watch(feedbackRepositoryProvider);
  ...
  return feedbackList.whenData((items) {
    return items.where((feedback) {
      ...
      if (filter.searchQuery.isNotEmpty) {
        ...
        final message = FeedbackMapper.getFirstMessage(feedback.messages)
            .toLowerCase();
...
class FeedbackCreateNotifier extends Notifier<FeedbackCreateState> {
  ...
  Future<bool> submit({String? item, String? state}) async {

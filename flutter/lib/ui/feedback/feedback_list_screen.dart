...
class FeedbackListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isManager = session?.isManager == true;
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(
                  flex: 2,
                  child: Text(l10n.title, style: Theme.of(context).textTheme.labelLarge),
                ),
                Expanded(
                  child: Text(l10n.type, style: Theme.of(context).textTheme.labelLarge),
                ),
                Expanded(
                  child: Text(l10n.priority, style: Theme.of(context).textTheme.labelLarge),
                ),
                Expanded(
                  child: Text(l10n.status, style: Theme.of(context).textTheme.labelLarge),
                ),
                Expanded(
                  child: Text(l10n.openDate, style: Theme.of(context).textTheme.labelLarge),
                ),
              ],
            ),
          ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FilledButton(
                        onPressed: () {
                          ref.read(feedbackFilterProvider.notifier).state = filter;
                          Navigator.pop(context);
                        },

...
tasks = """### 1. replace team-course list load with the existing count query (roadmap 1+7)
...
output = f"""2024-05-24 · HEAD · could not check open PRs

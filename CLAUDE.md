...
- Menu of four one-line fields (`resume_automerge`, `wait_minutes`, `force`, `dry_run`); `PLAYSTORE_TRACK`, `PLAYSTORE_DAILY_LIMIT` and `RETRY_MINUTES` are constants in the job's `env:`

...
| `docs/SKILL_SYNC_SETUP.md` | You're maintaining the shared agent skills (`merge-prepping`, `kotlin-importing`) — how one skill repo feeds Claude Code, OpenHands, and Copilot |

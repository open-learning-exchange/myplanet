...
**Phase 94 complete.** The Flutter app is *not* yet a replacement for the Kotlin app:
...
## Phase 95 — harvest audit of the 26 post-94 commits, and the ranked resource search
...
## Phase 96 — three search/sort/visibility gaps the deeper audit found
...
## Phase 97 — the notification sync-in direction, and read-state round-trip
...
**Phase**: 94 of N (27 of 28 UI packages have a screen — see Status for what that does and
does not mean)

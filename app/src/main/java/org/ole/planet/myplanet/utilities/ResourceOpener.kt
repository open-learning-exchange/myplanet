...
object ResourceOpener {
    ...
    fun openFileType(activity: Activity, items: RealmMyLibrary, videoType: String, activityService: UserActivityService) {
        ...
        activityService.setResourceOpenCount(items, UserActivityService.KEY_RESOURCE_OPEN)

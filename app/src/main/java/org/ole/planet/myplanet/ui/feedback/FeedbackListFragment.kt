...
class FeedbackListFragment : Fragment(), OnFeedbackSubmittedListener {
    ...
    private fun loadFeedbackData() {
        lifecycleScope.launch {
            feedbackRepository.getFeedback(userModel?.name ?: "", userModel?.isManager() ?: false)
                .collectLatest { feedbackList ->
    ...
    override fun onFeedbackSubmitted() {
        // No action needed here, the Flow will automatically update the list.
    }

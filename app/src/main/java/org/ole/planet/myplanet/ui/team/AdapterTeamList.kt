...
class AdapterTeamList(
    ...
    private val list: List<TeamData>,
    ...
    interface OnActionClickListener {
        fun onJoinClick(team: TeamData)
        fun onLeaveClick(team: TeamData)
    }
            ...
            if (teamStatus.isLeader) {
                ...
                AlertDialog.Builder(context, R.style.CustomAlertDialog).setMessage(R.string.confirm_exit)
                    .setPositiveButton(R.string.yes) { _: DialogInterface?, _: Int ->
                        actionClickListener?.onLeaveClick(team)
                    }.setNegativeButton(R.string.no, null).show()
            }
        } else {
            actionClickListener?.onJoinClick(team)
        }
    }

...
class AdapterCourses(
    ...
    private val progressMap: HashMap<String?, JsonObject>?
) : ListAdapter<RealmMyCourse, RecyclerView.ViewHolder>(courseDiffCallback(map, progressMap)) {
    ...
    companion object {
        ...
        private fun courseDiffCallback(
            map: HashMap<String?, JsonObject>,
            progressMap: HashMap<String?, JsonObject>?
        ) =
            object : DiffUtil.ItemCallback<RealmMyCourse>() {
                override fun areItemsTheSame(
                    oldItem: RealmMyCourse,
                    newItem: RealmMyCourse
                ): Boolean {

...
class ResourcesAdapter(
...
) : ListAdapter<RealmMyLibrary, RecyclerView.ViewHolder>(ITEM_CALLBACK) {
    ...
    companion object {
        ...
        val ITEM_CALLBACK = DiffUtils.itemCallback<RealmMyLibrary>(
            areItemsTheSame = { old, new -> old._id == new._id },
            areContentsTheSame = { old, new -> old._rev == new._rev && old.uploadDate == new.uploadDate }
        )
    }

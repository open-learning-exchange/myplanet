...
class UserListAdapter(private val onUserClicked: (RealmUserModel) -> Unit) :
    ListAdapter<RealmUserModel, UserListAdapter.ViewHolder>(USER_COMPARATOR) {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                getItem(adapterPosition)?.let { user -> onUserClicked(user) }
            }
        }

...
interface SubmissionsRepository {
    ...
    suspend fun saveAnswer(submissionId: String?, questionId: String, answer: String, listAnswers: Map<String, String>?, otherText: String?, type: String, index: Int, total: Int): Boolean
}

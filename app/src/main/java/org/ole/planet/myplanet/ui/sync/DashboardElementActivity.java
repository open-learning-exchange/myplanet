...
//        }
    ...
    public void wifiStatusSwitch() {
        ...
        if (mWifi.isConnected()) {
            ...
            Toast.makeText(this, R.string.wifi_is_turned_off_saving_battery_power, Toast.LENGTH_LONG).show();
        } else {
            wifi.setWifiEnabled(true);
            Toast.makeText(this, R.string.turning_on_wifi_please_wait, Toast.LENGTH_LONG).show();

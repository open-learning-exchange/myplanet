            ...
            coroutineScope {
                val syncJobs = listOf(
                    async {
                        ...
                        TransactionSyncManager.syncDb(databaseService, "tablet_users")

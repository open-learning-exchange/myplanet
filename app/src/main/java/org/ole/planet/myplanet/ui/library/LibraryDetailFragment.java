...
//        remove.setText(isAdd ? "Add To My Library" : "Remove from myLibrary");
        ...
        remove.setOnClickListener(view -> {
            ...
            Utilities.toast(getActivity(), getString(R.string.resource) + (isAdd ? getString(R.string.added_to) : getString(R.string.removed_from) + getString(R.string.my_library)));
            setLibraryData();
        });
    }

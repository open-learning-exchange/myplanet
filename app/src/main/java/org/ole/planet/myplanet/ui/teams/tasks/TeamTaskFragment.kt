...
import org.ole.planet.myplanet.ui.health.HealthUserSelectionAdapter
    ...
    private fun showTaskAlert(t: RealmTeamTask?) {
        ...
        alertTaskBinding.tvAssignMember.setOnClickListener {
            lifecycleScope.launch {
                ...
                val adapter: ArrayAdapter<RealmUserModel> = HealthUserSelectionAdapter(requireActivity(), android.R.layout.simple_list_item_1, filteredUserList)

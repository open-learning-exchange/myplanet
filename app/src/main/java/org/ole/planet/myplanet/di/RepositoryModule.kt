...
import org.ole.planet.myplanet.repository.FeedbacksRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindFeedbacksRepository(impl: FeedbacksRepositoryImpl): FeedbacksRepository

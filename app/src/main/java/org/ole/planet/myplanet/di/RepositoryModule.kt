...
import org.ole.planet.myplanet.repository.MyPersonalsRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindMyPersonalsRepository(impl: MyPersonalsRepositoryImpl): MyPersonalsRepository
}

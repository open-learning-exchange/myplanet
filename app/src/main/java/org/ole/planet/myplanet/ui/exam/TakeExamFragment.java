...
public class TakeExamFragment extends BaseExamFragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, CameraUtils.ImageCaptureCallback {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (questions.size() > 0) {
            ...
            Snackbar.make(tvQuestionCount, getString(R.string.no_questions), Snackbar.LENGTH_LONG).show();
        }
    }
...
//        }
        ...
        sub.setStatus(getString(R.string.pending));
        sub.setType(type);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
            ...
            showTextInput(type);
            if (showErrorMessage(getString(R.string.please_select_to_continue))) {
                return;
            }

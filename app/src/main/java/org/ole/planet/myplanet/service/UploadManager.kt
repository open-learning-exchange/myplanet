...
class UploadManager @Inject constructor(
    ...
    private fun uploadNewsActivities() {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            newsLog.processInBatches { news ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/myplanet_activities", RealmNewsLog.serialize(news))?.execute()?.body()
    ...
    fun uploadActivities(listener: SuccessListener?) {
        ...
        try {
            apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/myplanet_activities", MyPlanet.getNormalMyPlanetActivities(MainApplication.context, pref, model))?.enqueue(object : Callback<JsonObject?> {
                override fun onResponse(call: Call<JsonObject?>, response: Response<JsonObject?>) {}

                override fun onFailure(call: Call<JsonObject?>, t: Throwable) {}
            })

            apiInterface?.getJsonObject("${UrlUtils.getUrl()}/myplanet_activities/${getAndroidId(MainApplication.context)}@${NetworkUtils.getUniqueIdentifier()}")?.enqueue(object : Callback<JsonObject?> {
                override fun onResponse(call: Call<JsonObject?>, response: Response<JsonObject?>) {
                    ...
                    apiInterface.postDoc("application/json", "${UrlUtils.getUrl()}/myplanet_activities", `object`).enqueue(object : Callback<JsonObject?> {
                        override fun onResponse(call: Call<JsonObject?>, response: Response<JsonObject?>) {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            data.processInBatches { sub ->
                    try {
                        ...
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/courses_progress", RealmCourseProgress.serializeProgress(sub))?.execute()?.body()
                        if (`object` != null) {
    ...
    fun uploadFeedback(listener: SuccessListener) {
        ...
        realm.executeTransactionAsync(Realm.Transaction { realm: Realm ->
            ...
            feedbacks.processInBatches { feedback ->
                try {
                    val res: Response<JsonObject>? = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/feedback", RealmFeedback.serializeFeedback(feedback))?.execute()
    ...
    fun uploadSubmitPhotos(listener: SuccessListener?) {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            data.processInBatches { sub ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/submissions", RealmSubmitPhotos.serializeRealmSubmitPhotos(sub))?.execute()?.body()
                        if (`object` != null) {
    ...
    fun uploadMyPersonal(personal: RealmMyPersonal, listener: SuccessListener) {
        ...
        if (!personal.isUploaded) {
            apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/resources", RealmMyPersonal.serialize(personal, context))?.enqueue(object : Callback<JsonObject?> {
                override fun onResponse(call: Call<JsonObject?>, response: Response<JsonObject?>) {
    ...
    fun uploadTeamTask() {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            tasksToUpload.processInBatches { task ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/tasks", RealmTeamTask.serialize(realm, task))?.execute()?.body()
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            list.processInBatches { submission ->
                    try {
                        ...
                        val response = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/submissions", requestJson)?.execute()
    ...
    fun uploadTeams() {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            teams.processInBatches { team ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/teams", RealmMyTeam.serialize(team))?.execute()?.body()
                        if (`object` != null) {
        ...
        realm.executeTransactionAsync({ transactionRealm: Realm ->
            ...
            activities.processInBatches { act ->
                try {
                    ...
                    val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/login_activities", RealmOfflineActivity.serializeLoginActivities(act, context))?.execute()?.body()
    ...
    fun uploadTeamActivities(realm: Realm, apiInterface: ApiInterface?) {
        ...
        logs.processInBatches { log ->
                try {
                    val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/team_activities", RealmTeamLog.serializeTeamActivities(log, context))?.execute()?.body()
                    if (`object` != null) {
                    ...
                    try {
                        ...
                        val `object`: Response<JsonObject>? =
                            if (TextUtils.isEmpty(act._id)) {
                                apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/ratings", RealmRating.serializeRating(act))?.execute()
                            } else {
                                apiInterface?.putDoc("application/json", "${UrlUtils.getUrl()}/ratings/" + act._id, RealmRating.serializeRating(act))?.execute()
                            }
                        if (`object`?.body() != null) {
            ...
            activities.processInBatches { act ->
                    try {
                        ...
                        if (act.imageUrls != null && act.imageUrls?.isNotEmpty() == true) {
                            act.imageUrls?.chunked(5)?.forEach { imageChunk ->
                                imageChunk.forEach { imageObject ->
                                    ...
                                    val response = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/resources", ob)?.execute()?.body()
                        ...
                        val newsUploadResponse: Response<JsonObject>? =
                            if (TextUtils.isEmpty(act._id)) {
                                apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/news", `object`)?.execute()
                            } else {
                                apiInterface?.putDoc("application/json", "${UrlUtils.getUrl()}/news/" + act._id, `object`)?.execute()
                            }
    ...
    private fun uploadCrashLogData(realm: Realm, apiInterface: ApiInterface?) {
        ...
        logs.processInBatches { act ->
                try {
                    val o = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/apk_logs", RealmApkLog.serialize(act, context))?.execute()?.body()
    ...
    fun uploadSearchActivity() {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            logs.processInBatches { act ->
                    try {
                        val o = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/search_activities", act.serialize())?.execute()?.body()
                        if (o != null) {
                            act._rev = getString("rev", o)
                        }
                    } catch (e: IOException) {
    ...
    fun uploadResourceActivities(type: String) {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            activities.processInBatches { act ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/" + db, RealmResourceActivity.serializeResourceActivities(act))?.execute()?.body()
    ...
    fun uploadCourseActivities() {
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            activities.processInBatches { act ->
                    try {
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/course_activities", RealmCourseActivity.serializeSerialize(act))?.execute()?.body()
        ...
        realm.executeTransactionAsync { realm: Realm ->
            ...
            meetups.processInBatches { meetup ->
                    try {
                        ...
                        val `object` = apiInterface?.postDoc("application/json", "${UrlUtils.getUrl()}/meetups", meetupJson)?.execute()?.body()

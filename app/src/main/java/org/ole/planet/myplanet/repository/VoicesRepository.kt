...
interface VoicesRepository {
    ...
    suspend fun getCommunityNews(userIdentifier: String, page: Int, pageSize: Int): Flow<List<RealmNews>>
    suspend fun getCommunityNews(userIdentifier: String): Flow<List<RealmNews>> = getCommunityNews(userIdentifier, 1, -1)
    ...
    suspend fun getDiscussionsByTeamIdFlow(teamId: String, page: Int, pageSize: Int): Flow<List<RealmNews>>
    suspend fun getDiscussionsByTeamIdFlow(teamId: String): Flow<List<RealmNews>> = getDiscussionsByTeamIdFlow(teamId, 1, -1)
    ...
    suspend fun updateNews(newsId: String, message: String)
    suspend fun createReply(replyToId: String, message: String, user: RealmUserModel?): RealmNews
}

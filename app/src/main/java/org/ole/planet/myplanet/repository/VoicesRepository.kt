...
interface VoicesRepository {
    ...
    suspend fun createNews(map: HashMap<String?, String>, user: RealmUser?, imageList: io.realm.RealmList<String>?, videoList: io.realm.RealmList<String>? = null): RealmNews
    suspend fun createTeamNews(newsData: HashMap<String?, String>, user: RealmUser, imageList: io.realm.RealmList<String>?, videoList: io.realm.RealmList<String>? = null): Boolean

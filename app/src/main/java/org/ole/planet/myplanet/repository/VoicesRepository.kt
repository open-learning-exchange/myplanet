...
interface VoicesRepository {
    ...
    suspend fun createReply(s: String?, news: RealmNews?, currentUser: RealmUserModel?, imageList: io.realm.RealmList<String>?)
    suspend fun updateNewsMessage(s: String, newsId: String?, imageList: io.realm.RealmList<String>?, imagesToRemove: Set<String>)

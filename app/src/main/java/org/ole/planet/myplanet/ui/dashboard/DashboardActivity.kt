...
class DashboardActivity : DashboardElementActivity(), OnHomeItemClickListener, NavigationBarView.OnItemSelectedListener, NotificationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val courseId = "029d3479cecb2036fa4f38908402ea5c"
...
//            if (settings.getString("serverURL", "") == "https://${BuildConfig.PLANET_GUATEMALA_URL}") {
                ...
                if (progress != null) {
                    ...
                    challengeDialog(remainingDays, loginCount, resourceOpenCount, syncCount, voiceCount, aiResearchCount, courseStatus)
                } else {
                    challengeDialog(remainingDays, loginCount, resourceOpenCount, syncCount, voiceCount, aiResearchCount, "$courseName not started")
                }
            }
//        }
//    }

    private fun challengeDialog(remainingDays: Int, loginCount: Int, resourceOpenCount: Int, syncCount: Int, voiceCount: Int, aiResearchCount: Int, courseStatus: String) {

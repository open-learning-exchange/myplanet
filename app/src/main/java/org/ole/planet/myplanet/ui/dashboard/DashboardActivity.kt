...
import org.ole.planet.myplanet.domain.NotificationCreator
...
class DashboardActivity : DashboardElementActivity(), OnHomeItemClickListener, NavigationBarView.OnItemSelectedListener, NotificationListener {
    ...
    private lateinit var challengeEvaluator: ChallengeEvaluator
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        notificationCreator = NotificationCreator(dashboardViewModel, notificationManager)
        challengeEvaluator = ChallengeEvaluator(mRealm, user, settings, editor)
        ...
        challengeHelper = ChallengeHelper(this, mRealm, user, settings, editor, challengeEvaluator, dashboardViewModel)
            ...
            try {
                databaseService.realmInstance.use { backgroundRealm ->
                    backgroundRealm.executeTransaction { realm ->
                        val createdNotifications = notificationCreator.createNotifications(realm, userId)

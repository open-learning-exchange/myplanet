...
interface UploadRepository {
    ...
    suspend fun uploadTeams(teamsToUpload: List<org.ole.planet.myplanet.repository.TeamUploadData>): Response<com.google.gson.JsonArray>
    suspend fun uploadTeamActivities(activitiesToUpload: com.google.gson.JsonArray): Response<com.google.gson.JsonArray>
}

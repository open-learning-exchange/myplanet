...
class UserRepositoryImpl @Inject constructor(
    ...
    override suspend fun getHealthRecordsAndAssociatedUsers(
        ...
        val detachedMh = realm.copyFromRealm(mh)
        val json = AndroidDecrypter.decrypt(detachedMh.data, currentUser.key, currentUser.iv)
        ...
        if (list.isEmpty()) {
            return@withRealm HealthRecord(detachedMh, mm, emptyList(), emptyMap())
        }
        ...
        HealthRecord(detachedMh, mm, list, userMap)
    }

...
//
//        if (resourceId != null) {
//            val file = File(getExternalFilesDir(null), "ole/$resourceId/index.html")
//            if (file.exists()) {
//                activityWebViewBinding.contentWebView.wv.loadUrl("file://${file.absolutePath}")
//            }
//        } else {
//            activityWebViewBinding.contentWebView.wv.loadUrl(link)
//        }
...
//            ): WebResourceResponse? {
//                val url = request.url.toString()
//                if (url.startsWith("file://") && resourceId != null) {
//                    val path = url.replace("file://${getExternalFilesDir(null)}/ole/$resourceId/", "")
//                    val file = File(getExternalFilesDir(null), "ole/$resourceId/$path")
//                    if (file.exists()) {
//                        return null // Let WebView handle existing local files
//                    }
//                }
//                return super.shouldInterceptRequest(view, request)
//            }

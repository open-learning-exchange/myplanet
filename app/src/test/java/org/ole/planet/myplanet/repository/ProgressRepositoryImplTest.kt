...
class ProgressRepositoryImplTest {
    ...
    fun testHasUserCompletedSync() = testScope.runTest {
        coEvery {
            repository invoke "count" withArguments listOf(org.ole.planet.myplanet.model.RealmUserChallengeActions::class.java, any<Function1<io.realm.RealmQuery<org.ole.planet.myplanet.model.RealmUserChallengeActions>, Unit>>())
        } returns 1L

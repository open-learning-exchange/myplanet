...
class TransactionSyncManagerTest {
    ...
    private val chatRepository: ChatSyncRepository = mockk()
    private val feedbackRepository: FeedbackSyncRepository = mockk()
    ...
    private val communityRepository: CommunitySyncRepository = mockk()

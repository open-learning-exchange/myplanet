...
class MyHealthTest {
    ...
    fun formatConditions_nullReturnsEmpty() {
        assertEquals("", MyHealth.formatConditions(null))
    }

    @Test
    fun formatConditions_emptyReturnsEmpty() {
        assertEquals("", MyHealth.formatConditions(""))
    }
    ...
    fun formatConditions_onlyTrueFlagsAreJoined() {
        ...
        val result = MyHealth.formatConditions(conditions).split(", ").toSet()
    ...
    fun formatConditions_allFalseReturnsEmpty() {
        ...
        assertEquals("", MyHealth.formatConditions(conditions))
    }
    ...
    fun formatConditions_malformedJsonReturnsEmpty() {
        assertEquals("", MyHealth.formatConditions("{not valid json"))
    }

    @Test
    fun formatConditions_nonObjectJsonReturnsEmpty() {
        assertEquals("", MyHealth.formatConditions("[\"diabetes\", \"asthma\"]"))
    }
